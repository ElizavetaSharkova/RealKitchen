...
public class Book : MonoBehaviour {
    ...
    public Button cookRight;
    public Button cookLeft;
    ...
    void Start()
    {
       ...
       // UpdateSprites();
        ...
        cookRight.onClick.AddListener(delegate { CookIt(cookRight); });
        cookLeft.onClick.AddListener(delegate { CookIt(cookLeft); });
    }
    ...
    public void UpdateSprites()
    {
        if (currentPage > 0 && currentPage <= bookPages.Length)
        {
            ...
            textLeft.text = (currentPage).ToString();          
            cookLeft.gameObject.active = true;
            btnPrev.gameObject.active = true;
            
            GameObject.Find("LeftNext").gameObject.transform.GetChild(0).gameObject.transform.GetChild(1).gameObject.GetComponent<RecipentParse>().ParseXML(currentPage-1);
        ...
        else
        {
            ...
            cookLeft.gameObject.active = false;
            btnPrev.gameObject.active = false;
            for (int i = 0; i < textLeft.gameObject.transform.childCount; i++)
            {
                textLeft.gameObject.transform.GetChild(i).gameObject.GetComponent<Text>().text = "";
                if (textLeft.gameObject.transform.GetChild(i).gameObject.transform.childCount > 0)
                {
                    textLeft.gameObject.transform.GetChild(i).gameObject.transform.GetChild(0).GetComponent<Text>().text = "";
                }
            }
        }
        ...
        if (currentPage >= 0 && currentPage < bookPages.Length)
        {
            ...
            textRight.text = (currentPage+1).ToString();
            cookRight.gameObject.active = true;
            btnNext.gameObject.active = true;
            
            GameObject.Find("RightNext").gameObject.transform.GetChild(0).gameObject.transform.GetChild(1).gameObject.GetComponent<RecipentParse>().ParseXML(currentPage);
        ...
        else
        {
            ...
            textRight.text = "";
            cookRight.gameObject.active = false;
            btnNext.gameObject.active = false;
            for (int i = 0; i < textRight.gameObject.transform.childCount; i++)
            {
                textRight.gameObject.transform.GetChild(i).gameObject.GetComponent<Text>().text = "";
                if (textRight.gameObject.transform.GetChild(i).gameObject.transform.childCount > 0)
                {
                    textRight.gameObject.transform.GetChild(i).gameObject.transform.GetChild(0).GetComponent<Text>().text = "";
                }
            }
    ...
    public void CookIt(Button click)
    {
        btnPrev.gameObject.active = false;
        btnNext.gameObject.active = false;
        leftOrRight = click.gameObject.name.Remove(0, 4);
        leftOrRight = "Recipe" + leftOrRight + "Text";
        if (leftOrRight == "RecipeRightText")
        {
            GameObject.Find("RecipeRightText").GetComponent<RecipentParse>().StartStatus();
            
        }
        else  GameObject.Find("RecipeLeftText").GetComponent<RecipentParse>().StartStatus();
